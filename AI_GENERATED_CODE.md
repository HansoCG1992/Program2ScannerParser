...
**Project:** Program 2 - Scanner and Parser  
**Name:** Cole Hanson  
**AI Tool:** Claude (Anthropic)

This document lists all AI-generated code that was incorporated into the final project.

---

## Table of Contents
1. [Token and Node Structures](#token-and-node-structures)
2. [Lexer (Tokenizer)](#lexer-tokenizer)
3. [Parser Helper Functions](#parser-helper-functions)
4. [Statement Parsing Functions](#statement-parsing-functions)
5. [Expression Parsing Functions](#expression-parsing-functions)
6. [Main Parse Function](#main-parse-function)
...
;; MODIFIED: Changed parse-expr to parse-term to fix comparison operator bug
...
- **Major modifications made:**
  - Fixed parse-if-stmt to use parse-term (2 changes)
  - Fixed parse-while-stmt to use parse-term (2 changes)
  - Rewrote parse-stmt to handle compound statements
  - Added run-all-tests function and help message
